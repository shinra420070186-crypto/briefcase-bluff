...
const GAME_STYLES = `
  ...
  /* THE WENDELL47 BUTTONS */
  .wendell-btn { display: inline-flex; align-items: center; justify-content: center; padding: 15px 30px; border: 0; position: relative; overflow: hidden; border-radius: 10rem; transition: all 0.02s; font-weight: bold; cursor: pointer; color: rgb(37, 37, 37); background-color: #ffffff; z-index: 0; box-shadow: 0 0px 7px -5px rgba(0, 0, 0, 0.5); outline: none; -webkit-tap-highlight-color: transparent; }
  ...
  .wendell-hoverEffect div { background: linear-gradient(90deg, rgba(222, 0, 75, 1) 0%, rgba(191, 70, 255, 1) 49%, rgba(0, 212, 255, 1) 100%); border-radius: 40rem; width: 10rem; height: 10rem; transition: 0.4s; filter: blur(20px); animation: wendell-effect infinite 3s linear; opacity: 0.5; }
  .wendell-btn:hover .wendell-hoverEffect div { width: 8rem; height: 8rem; }
