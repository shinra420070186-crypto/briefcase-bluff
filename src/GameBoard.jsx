...
const ActiveGameSky = () => (
  <div className="absolute inset-0 w-full h-full overflow-hidden z-0 pointer-events-none active-game-sky">
    <div className="jk-stars-1"></div>
    <div className="jk-stars-2"></div>
    <div className="jk-stars-3"></div>
  </div>
);
...
const GlobalStyles = () => (
  <style>{`
    ...
    /* ====================================================
       JAYKDOE ACTIVE GAME BACKGROUND CSS
       ==================================================== */
    .active-game-sky {
      background: #090a0f;
      background: radial-gradient(ellipse at bottom, #1b2735 0%, #090a0f 100%);
    }
    .jk-stars-1, .jk-stars-2, .jk-stars-3 {
      position: absolute;
      top: 0;
      left: 0;
      background: transparent;
    ...
    .jk-stars-1 {
      ...
      .active-game-sky .jk-stars-2:after {
      ...
      .active-game-sky .jk-stars-3:after {
