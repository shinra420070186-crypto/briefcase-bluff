...
const GAME_STYLES = `
  ...
  /* ====================================================
     WENDELL47 BUTTON CSS (Scoped) - FULL COVERAGE FIX
     ==================================================== */
  .wendell-btn {
    display: inline-flex;
    align-items: center;
  ...
  .wendell-hoverEffect div {
    ...
    border-radius: 40rem;
    /* THE FIX: Increased from 10rem to 25rem to fill wide buttons edge-to-edge */
    width: 25rem; 
    height: 25rem;
    transition: 0.4s;
    filter: blur(20px);
  ...
  .wendell-btn:hover .wendell-hoverEffect div {
    /* Increased proportionately to match the new size */
    width: 21rem; 
    height: 21rem;
  }
...
export default function GameBoard() {
  ...
  // --- EXACTLY 250MS DELAY FOR PAGE TRANSITIONS ---
